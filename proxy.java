...
public class proxy  implements Server_interface {
...
private String find;
	...
	public proxy() throws IOException {
		...
		socket = new Socket(addr, Server_interface.PORT);
...
public void uploadToDb1(Socket socket,String query, String nome_tabella) throws IOException {
	...
	public Boolean login(Socket socket, String query, String User) throws IOException {
